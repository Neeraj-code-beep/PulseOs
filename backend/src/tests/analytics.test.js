...
const runTests = async () => {
  ...
  try {
    ...
    const emptyOverview = await analyticsService.getOverview();
    ...
    const bOverview = await analyticsService.getOverview();
    ...
    const cOverview = await analyticsService.getOverview();
    ...
    const dOverview = await analyticsService.getOverview();
    ...
    const trend7 = await analyticsService.getFocusTrend(7);
    ...
    const trend14 = await analyticsService.getFocusTrend(14);
    console.assert(trend14.points.length === 14, `L Fail: got ${trend14.points.length}`);
    const trend30 = await analyticsService.getFocusTrend(30);
    ...
    const invalidReqs = [{ query: { days: '0' } }, { query: { days: '-1' } }, { query: { days: '100' } }, { query: { days: 'abc' } }];
    ...
    const gOverview = await analyticsService.getOverview();
    ...
    const hOverview = await analyticsService.getOverview();
    ...
    const iOverview = await analyticsService.getOverview();
    ...
    const perfO = await analyticsService.getTaskPerformance();
    ...
    const perfP = await analyticsService.getTaskPerformance();
